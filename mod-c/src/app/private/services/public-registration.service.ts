...
getUser(){
  ...
  return this.httpclient.get('http://192.168.1.87:8084/api/v1/company/user/users',httpOptions)
  // return this.httpclient.get('http://192.168.1.87:8083/api/v1/company/user/find-user/'+this.username,httpOptions)
...
userProfile(file:File,id:string){
  ...
  return this.httpclient.post('http://192.168.1.87:8084/api/v1/company/user/imageUpload/'+id,fd,
  {
    headers:{
